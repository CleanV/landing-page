  ...
  return (
    <>
      <div className="fixed top-0 w-screen max-w-full z-40">
        <nav className={`relative px-4 py-4 flex justify-between items-center ${!scrollState ? 'transparent' : 'bg-white'}`}>
      ...
      {isNavbarActive && <div class="navbar-menu relative z-50">
        <div class="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25" onClick={() => setNavbarActive(false)}></div>
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          <div class="flex items-center mb-8">
            ...
            <button class="navbar-close" onClick={() => setNavbarActive(false)}>
