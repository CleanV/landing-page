...
const NavbarComponent = () => {
  ...
  return (
    <>
      {/* Navbar Atas */}
      <div className="fixed top-0 w-screen max-w-full z-40">
        <nav className={`relative px-4 py-4 flex justify-between items-center transition duration-200 ${!scrollState ? 'transparent' : 'bg-white'}`}>
          <a className="text-3xl font-bold leading-none" href="#">
            CleanV
          </a>
          <div className="lg:hidden">
            <button className="navbar-burger flex items-center text-blue-600 p-3" onClick={() => setNavbarActive(true)}>
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            ...
            <li><a className="text-sm text-gray-400 hover:text-gray-500 font-bold" href="#">About Us</a></li>
            <li className="text-gray-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
              </svg>
      ...
      {/* Navbar Samping */}
      <div className={`navbar-menu z-50 ${isNavbarActive ? 'relative' : 'hidden'}`}>
        <div className="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25" onClick={() => setNavbarActive(false)}></div>
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          <div className="flex items-center mb-8">
            ...
            <button className="navbar-close" onClick={() => setNavbarActive(false)}>
